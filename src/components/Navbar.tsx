        ...
        <nav className="fixed top-0 z-50 w-full border-b border-neutral-800 bg-black/70 backdrop-blur-xl">
            <div className="flex w-full items-center justify-between px-3 py-3 sm:px-6 sm:py-5 md:px-10">
                <div className="flex min-w-0 items-center font-mono text-lg font-bold tracking-tight text-neutral-100 sm:text-3xl">
                    ...
                    <span className="truncate">emily.dev</span>
                ...
                <div className="flex shrink-0 items-center gap-3 text-neutral-300 sm:gap-6">
                    <a
                        href="#experience"
                        className="hidden font-mono text-sm transition hover:text-white md:block"
                    >
                        experience
                    </a>
                    ...
                    >
                        <FaGithub className="h-6 w-6 sm:h-[34px] sm:w-[34px]" />
                    </a>
                    ...
                    <a
                        ...
                        className="transition hover:scale-110 hover:text-white"
                    >
                        <FaLinkedin className="h-6 w-6 sm:h-[34px] sm:w-[34px]" />
                    </a>
                    ...
                    >
                        {!mounted ? (
                            <span className="block h-6 w-6 sm:h-[34px] sm:w-[34px]" />
                        ) : theme === "dark" ? (
                            <Sun className="h-6 w-6 text-yellow-300 sm:h-[34px] sm:w-[34px]" />
                        ) : (
                            <Moon className="h-6 w-6 text-blue-400 sm:h-[34px] sm:w-[34px]" />
                        )}
                    </button>
                </div>
            </div>
